...
function TinybirdProvider(props) {
    return (React.createElement(React.Fragment, null,
        React.createElement(Head, null,
            React.createElement("script", { async: true, "data-token": props.token, "data-source": props.dataSource, "data-api": props.apiUrl || tinybirdDomain, src: props.trackerURL || tinybirdTrackerURL }),
